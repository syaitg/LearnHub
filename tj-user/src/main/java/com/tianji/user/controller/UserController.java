...
public class UserController {
    ...
    @PutMapping(value = "/me")
    public void updateCurrentUserProfile(@Valid @RequestBody CurrentUserProfileDTO profileDTO) {
        userService.updateCurrentUserProfile(profileDTO);
    }

    @Operation(summary = "修改当前用户密码")
    @PutMapping(value = "/me/password")
    public void updateCurrentUserPassword(@Valid @RequestBody CurrentUserPasswordDTO passwordDTO) {
