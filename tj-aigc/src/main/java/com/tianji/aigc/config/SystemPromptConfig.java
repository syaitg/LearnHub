...
public class SystemPromptConfig {
    ...
    @PostConstruct // 初始化时加载配置 // 初始化完成之后，执行这个方法
    public void init() {
        // 读取配置文件
    ...
    private void loadConfig(AIProperties.System.Chat chatConfig, AtomicReference<String> target) {  // 从 nacos配置文件 中读取数据，然后 set 到 target 中
        try {
