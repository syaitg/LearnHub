...
public class SpringAIConfig {
    ...
    /**
     * Applies longer timeouts to synchronous Spring AI HTTP calls.
     * The default OkHttp read timeout (10 seconds) is too short for complex agent prompts.
     */
    @Bean
    public RestClientCustomizer aiRestClientTimeoutCustomizer(DashScopeProperties properties) {
    ...
    /**
     * Configures the default DashScope ChatClient.
     */
    @Bean
