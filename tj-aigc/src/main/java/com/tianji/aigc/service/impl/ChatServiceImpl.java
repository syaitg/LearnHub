...
@ConditionalOnProperty(prefix = "tj.ai", name = "chat-type", havingValue = "ENHANCE")  // 根据chat-type条件注入实现类（现在有2个实现类，不能同时注入）
    ...
    public Flux<ChatEventVO> chat(String question, String sessionId) {
        ...
        return this.chatClient.prompt()
                .system(promptSystem -> promptSystem
                        ...
                        .params(Map.of("now", DateUtil.now())) // 设置参数：系统提示词当前时间参数
                )
