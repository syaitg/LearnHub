...
public class MediaController {
     ...
     * @return 媒资 AI 信息
     */
    @Operation(summary = "查询视频 AI 处理所需的媒资信息")
    @GetMapping("/{id}/ai-info")
    public MediaAiInfoDTO queryAiInfo(@PathVariable("id") Long mediaId,
                                      @RequestParam("courseId") Long courseId,
                                      @RequestParam("sectionId") Long sectionId) {
        return mediaService.queryAiInfo(mediaId, courseId, sectionId);
    }
