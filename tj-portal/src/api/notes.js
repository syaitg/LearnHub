...
// 采集笔记
// Legacy API: POST /notes/{id} is not implemented and has no active page caller.
/*
...
// 笔记点赞
// Legacy API: learning-service has no /note/{id} endpoint and the UI control is disabled.
/*
