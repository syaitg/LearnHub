...
// Legacy API: backend endpoint no longer exists and there is no active page caller.
/*
...
request({
	url: `${EXAM_API_PREFIX}/practice-sessions/page`,
	method: 'get',
	params
})
// 查询我的考试记录详情
...
request({
	url: `${EXAM_API_PREFIX}/practice-sessions/${id}`,
	method: 'get',
})
// 提交考试答案，考试或测试提交时需要保存答案信息
// Legacy API: replaced by /practice-sessions; keep disabled to prevent accidental calls.
/*
