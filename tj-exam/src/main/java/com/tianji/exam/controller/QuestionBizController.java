...
public class QuestionBizController {
    ...
    @Operation(summary = "按业务目录批量清理题目关系")
    @DeleteMapping("/biz")
    public void deleteQuestionBizInfoByBizIds(@RequestParam("ids") List<Long> bizIds) {
        bizService.deleteQuestionBizInfoByBizIds(bizIds);
    }
}
