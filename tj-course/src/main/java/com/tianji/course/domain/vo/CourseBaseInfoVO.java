...
public class CourseBaseInfoVO {
    ...
    @Schema(description = "创建时间", example = "2026-07-11T11:59:00")
    private LocalDateTime createTime;

    @Schema(description = "封面url", example = "http://example.com/cover.jpg")
    private String coverUrl;

    @Schema(description = "更新时间", example = "2026-07-11T11:59:00")
    ...
    @Schema(description = "购买有效期开始", example = "2026-07-11T11:59:00")
