...
public class CourseCatalogueServiceImpl extends ServiceImpl<CourseCatalogueMapper, CourseCatalogue> implements ICourseCatalogueService {
    ...
    public CatalogueDetailDTO queryCatalogueDetail(Long id) {
        CourseCatalogue catalogue = getById(id);
        if (catalogue == null) {
            return null;
        }
        return BeanUtils.toBean(catalogue, CatalogueDetailDTO.class);
    }
    ...
    public List<CatalogueDetailDTO> queryCatalogueDetails(List<Long> ids) {
        ...
        List<CourseCatalogue> catalogues = lambdaQuery()
                .in(CourseCatalogue::getId, ids)
                .list();
